...
class TieredStorageWithLoadTest(PreallocNodesTest):
    ...
    def stage_block_s3(self):
        ...
        with firewall_blocked(self.redpanda.nodes, self.s3_port):
            ...
            wait_until(lambda: not self.cloud_storage_no_new_errors(self.redpanda, self.logger),
        ...
        wait_until(lambda: self.cloud_storage_no_new_errors(self.redpanda, self.logger),
